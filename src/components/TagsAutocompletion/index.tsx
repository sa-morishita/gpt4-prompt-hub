...
import type { TagsAutocompletionProps } from "~/models/tag";

const MemoizedCheckIcon = memo(CheckIcon);
const MemoizedChevronDoubleDownIcon = memo(ChevronDoubleDownIcon);

const TagsAutocompletion: FC<TagsAutocompletionProps> = ({
  tags,
  selectedTags,
  setSelectedTags,
}) => {
...
export default TagsAutocompletion;
